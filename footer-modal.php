...
<div id="modal" class="modal">
	<div class="modal-inner">
		...
		<div class="modal-hentry">
			<!-- This is the close button -->
			<a href="#" id="btnClose" title="Click here to close this deal box."></a>
			<!-- This is the left side of the popup for the description -->
			<!-- Calendly inline widget begin -->
			<div class="calendly-inline-widget" data-url="https://calendly.com/leaskrinjar/call_with_lea?hide_gdpr_banner=1" style="min-width:320px;height:630px;"></div>
